...
public class CreateDoubleProductLoanAccount extends Script {

    private static final Logger LOG = LoggerFactory.getLogger(CreateDoubleProductLoanAccount.class);
    ...
    public void execute(Map<String, Object> parameters) throws BusinessException {
        ...
        try {
            ...
            crossStorageApi.createOrUpdate(defaultRepo, loanaccount);
        } catch (Exception e) {
